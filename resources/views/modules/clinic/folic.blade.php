            ...
            <div class="table-responsive">
                <table class="table" id="studentTable">
                    ...
                    <tr>
                        ...
                        <td>{{ $section->check_count }}</td>
                        <td>
                            <a  href="{{ route('clinic.folic.section', $section->id) }}" style="color:grey;"><button class="btn btn-default">View Section</button></a>
                        </td>
                    </tr>
                    @endforeach
                    </tbody>
