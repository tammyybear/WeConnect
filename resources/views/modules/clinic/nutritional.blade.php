...
<div class="row bg-title">
    ...
    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
        <ol class="breadcrumb">
            ...
            <li class="active">Nutritional Structure</li>
        </ol>
    </div>
</div>
<div class="row">
            ...
            <div class="table-responsive">
                <table class="table" id="studentTable">
                    ...
                    <tr>
                        ...
                        <td>
                            <a  href="{{ route('clinic.nutritional.section', $section->id) }}" style="color:grey;"><button class="btn btn-default">View Section</button></a>
                        </td>
                    </tr>
                    @endforeach
                    </tbody>
